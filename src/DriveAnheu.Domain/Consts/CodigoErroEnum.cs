...
namespace DriveAnheu.Domain.Consts
{
    public enum CodigoErroEnum
    {
        ...
        #region 400
        [Description("O servidor não pode ou não irá processar a requisição porque algo está inválido")]
        BadRequest = 400,

        [Description("Não autorizado")]
        NaoAutorizado = 403,

        [Description("Você não é o dono desse item, portanto a requisição não foi autorizada")]
